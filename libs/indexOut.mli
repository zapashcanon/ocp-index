...
module Format : sig
  ...
  val path :
    ?short:bool -> ?colorise:coloriser -> Format.formatter -> info -> unit
  ...
  val doc :
    ?escaped:bool -> ?colorise:coloriser -> Format.formatter -> info -> unit
...
module Print : sig
  ...
  val format :
    ?root:string -> ?separate:bool -> string -> ?color:bool -> info -> string
end
